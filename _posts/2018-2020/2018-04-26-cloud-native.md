...
很多流行的开源项目都加入了支持gRPC接口的行列，甚至一些微服务基础设施内部就是用gRPC进行通信的；具体的细节可以参看[前面这篇文章]
({{site.baseurl}}{% post_url 2018-2020/2018-02-10-http2-and-grpc %})。
...
( {{site.baseurl}}{% post_url 2018-2020/2018-01-20-api-gw-to-servicemesh %})。
